<template>
  <div class="app-container">
    ...
    <div class="search-area">
      <el-form :inline="true" :model="searchForm" class="demo-form-inline">
        <el-form-item label="价格名称">
          <el-input v-model="searchForm.name" placeholder="请输入价格名称" clearable />
        </el-form-item>
    ...
    >
      ...
      <el-table-column min-width="180px" prop="name" label="价格名称" />
      <el-table-column min-width="150px" prop="productType" label="产品类型">
    ...
    >
      <el-form :model="form" :rules="rules" ref="form" label-width="100px">
        <el-form-item label="价格名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入价格名称" />
        </el-form-item>
